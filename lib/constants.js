...
export const ROLES = ['Admin', 'Coordinador', 'Inscripciones', 'Estudiantes', 'CoordinadorEstudiantes', 'Academico'];
export const PASSWORD_GENERICA = 'Hola123';

const NOMBRE_ROL = {
  Admin: 'Admin', Coordinador: 'Coordinador', Inscripciones: 'Inscripciones',
  Estudiantes: 'Estudiantes', CoordinadorEstudiantes: 'Coord. Estudiantes', Academico: 'Académico'
};
